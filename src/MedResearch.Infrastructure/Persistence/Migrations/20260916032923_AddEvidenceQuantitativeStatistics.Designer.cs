...
namespace MedResearch.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260916032923_AddEvidenceQuantitativeStatistics")]
    partial class AddEvidenceQuantitativeStatistics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedResearch.Domain.Evidence", b =>
                {
                    ...
                    b.Property<decimal?>("ReportedStandardError")
                        .HasColumnType("numeric(18,6)")
            ...
            modelBuilder.Entity("MedResearch.Domain.EvidenceExtraction", b =>
                {
                    ...
                    b.HasIndex("ResearchRunId", "StudyId", "SourceMaterialId", "PromptVersion")
                        .IsUnique()
            ...
            modelBuilder.Entity("MedResearch.Domain.ResearchReport", b =>
                {
                    ...
                    b.Property<int>("AbstractOnlyStudyCount")
                        .HasColumnType("integer")
                        .HasColumnName("abstract_only_study_count");
                    ...
                    b.Property<int>("NoSourceMaterialStudyCount")
                        .HasColumnType("integer")
                        .HasColumnName("no_source_material_study_count");
                    ...
                    b.Property<int>("StructuredFullTextStudyCount")
                        .HasColumnType("integer")
                        .HasColumnName("structured_full_text_study_count");
            ...
            modelBuilder.Entity("MedResearch.Domain.SourceMaterial", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.PrimitiveCollection<string[]>("SectionNames")
                        .IsRequired()
                        .HasColumnType("text[]")
                    ...
                    b.HasIndex("StudyId", "Type", "IsCurrent")
                        .HasDatabaseName("ix_source_materials_study_id_type_is_current");

                    b.HasIndex("StudyId", "Type", "Provider", "ProviderSourceId", "ContentHash")
                        .IsUnique()
            ...
            modelBuilder.Entity("MedResearch.Domain.EvidenceExtraction", b =>
                {
                    ...
                    b.HasOne("MedResearch.Domain.SourceMaterial", null)
                        .WithMany()
